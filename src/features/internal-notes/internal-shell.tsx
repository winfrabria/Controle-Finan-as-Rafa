    ...
    <div className={styles.shell}>
      <aside className={styles.sidebar}>
        <Link className={styles.brand} href="/notas" aria-label="WinfraBR">
          ...
          <span>Winfra<strong>BR</strong></span>
        </Link>
        <nav className={styles.navigation} aria-label="Navegação principal">
          ...
          <Link
            className={activePath === "/validacoes" ? styles.activeNav : undefined}
            href="/validacoes"
          >
        ...
        <div className={styles.sidebarUser}>
          ...
          <span><strong>Rafael</strong><small>{email}</small></span>
      ...
      <main className={styles.main}>
        <header className={styles.mobileHeader}>
          <Link className={styles.mobileBrand} href="/notas">Winfra<strong>BR</strong></Link>
        ...
        <div className={styles.content}>
          <header className={styles.pageHeader}>
            ...
            <Link className={styles.uploadButton} href="/">＋ Enviar nota</Link>
          </header>
          {children}
        </div>
      </main>
      ...
      <nav className={styles.mobileNav} aria-label="Navegação principal mobile">
        <Link
          className={activePath === "/notas" ? styles.activeMobileNav : undefined}
          href="/notas"
        >
          <span aria-hidden="true">▤</span>Notas
        </Link>
        <Link
          className={activePath === "/validacoes" ? styles.activeMobileNav : undefined}
          href="/validacoes"
        >
          <span aria-hidden="true">✓</span>Validações
        </Link>
        <Link href="/"><span aria-hidden="true">＋</span>Enviar</Link>
      </nav>
    </div>
  );
}
